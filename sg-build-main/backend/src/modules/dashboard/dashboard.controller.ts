...
const COLLECTION_ROUTE: Record<string, string> = {
  ...
  safetyInspections: '/safety/safety-inspection',
  safetyTrainings: '/safety/safety-training',
  safetyPunishments: '/safety/safety-punishment',
  safetyRewards: '/safety/safety-reward',
  safetyAccidents: '/safety/safety-accident',
  safetyInputLedgers: '/safety/safety-input-ledger',
