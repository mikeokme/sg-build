...
function seed(): { users: any[]; collections: Record<string, any[]>; settings: Record<string, any>; conversations: any[]; chatMessages: any[] } {
  ...
  const conversations = [
    ...
    { id: 'dg_hq', type: 'group', name: '集团总部群', category: 'department', departmentId: 'hq', members: ['admin','manager','张伟','李明','王磊','赵丽','孙强','周芳','吴刚','郑敏','马行政','钱人事','赵会计','周出纳','陈IT','林IT','何安全','高安全','梁质量','宋质量'], admins: ['manager','张伟'], owner: 'admin', createdAt: new Date(now - 86400000 * 10).toISOString() },
    ...
    { id: 'dg_hq_it',   type: 'group', name: '信息技术部群', category: 'department', departmentId: 'hq_it',   members: ['陈IT','林IT'], admins: [], owner: '陈IT', createdAt: new Date(now - 86400000 * 9).toISOString() },
  ...
  const users: any[] = [
    ...
    { id: 'u55', username: '陈IT', email: '陈IT@test.com', password: PWD_HASH, role: 'employee', appliedRole: 'employee', roleStatus: 'approved', isActive: true, createdAt: new Date().toISOString(), name: '陈IT',   department: '信息技术部', position: '部门经理', phone: '13900011005', isHead: true },
    { id: 'u56', username: '林IT', email: '林IT@test.com', password: PWD_HASH, role: 'employee', appliedRole: 'employee', roleStatus: 'approved', isActive: true, createdAt: new Date().toISOString(), name: '林IT',   department: '信息技术部', position: '开发工程师', phone: '13900011006' },
